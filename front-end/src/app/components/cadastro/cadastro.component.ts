  ...
  onSubmit(): void {
    ...
    if (this.clienteForm.valid) {
      const formData: Cliente = {
        ...
        cnpj:     this.identificacaoForm.get('cpfCnpj')?.value.replace(/\D/g, ''),
        ...
        ddd:      this.contatoForm.get('ddd')?.value.replace(/\D/g, ''),
        tel:      this.contatoForm.get('telefone')?.value.replace(/\D/g, ''),
